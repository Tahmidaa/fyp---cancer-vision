...
<div class="container-fluid border bg-white"style="width:900px;height: 650px; outline: 12px solid pink; opacity: 90%">
                ...
                <div class="text-dark offset-2 "style="width:590px; font-size: 18px; letter-spacing: 3px">
                  ...
                  <p><b> Cancer Type:</b> Colon Cancer </p>
                  <p><b> Status:</b> Positive </p>
                  <p><b> Test Suggestion:</b> Colonoscopy </p>
</div>
<br>
...
<div class="btn offset-2 "style="width:450px; font-size:14px; letter-spacing: 1px">
  Alternatively, look out the contact information for a colon cancer specialist to make it easier to get in touch with them. 
  </div>
  <a class="btn btn-success"style="width:120px; opacity:80%; font-size:16px" href= "{{ url('https://www.sunwaymedical.com/doctor/datuk-dr-chua-tee-joo') }}" >Specialist</a>
