...
<div class="container-fluid border bg-white"style="width:900px;height: 450px; outline: 12px solid pink; opacity: 90%">
                ...
                <div class="text-dark offset-2 "style="width:590px; font-size: 18px; letter-spacing: 3px">
                    <p><b> Output:</b> Based on your symptoms, you are most likely not suffering from cancer.</p>
                    <p><b> Cancer Type:</b> None </p>
                    <p><b> Status:</b> Negative </p>
                    <p><b> Test Suggestion:</b> None </p>
</div>
<br>
